...
public class User implements Serializable {
    ...
    //第二步:修改了javabean类(在此指User类). 导致 --- 类中的序列号 4900133124572371851
    //第三步:把文件中的对象读到内存. 本地中的序列号和类中的序列号不一致了.

    //解决?
    //不让虚拟机帮我们自动计算,我们自己手动给出.而且这个值不要变.
    //用对象序列化流序列化了一个对象后,如果我们修改了所属的Javabean类,读取数据将会抛出InvalidClassException异常
    //解决:给对象所属的类手动加一个serialVersionUID
    //如果想要使对象中的某个属性不想被序列化，则使用transient关键字修饰，该关键字标记的变量不参与序列化过程
